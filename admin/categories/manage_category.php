...
<div class="container-fluid">
	<form action="" id="category-form">
		...
		<div class="form-group">
			<label for="name" class="control-label"><i class="fas fa-edit"></i> Название категории: </label>
			<input name="name" id="name" class="form-control rounded-0 form no-resize" value="<?php echo isset($name) ? $name : ''; ?>" required>
		</div>
		<div class="form-group">
			<label for="description" class="control-label"><i class="fas fa-align-right"></i> Описание: </label>
