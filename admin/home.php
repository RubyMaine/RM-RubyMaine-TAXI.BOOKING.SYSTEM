...
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Доступные такси: </span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Зарегистрированные клиенты: </span>
                <span class="info-box-number">
                  <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Бронирования сделаны: </span>
                <span class="info-box-number">
                  <?php 
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Ожидающие бронирования: </span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Отмененные заказы: </span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Постоянные поездки: </span>
                <span class="info-box-number">
                <?php 
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Завершенные поездки: </span>
                <span class="info-box-number">
                <?php 
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text"> Пользователи системы: </span>
                <span class="info-box-number">
                <?php 
