...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5 card rounded-0 card-outline card-purple shadow">
        <div class="row">
            <div class="col-md-12">
            <center>
            <h1 class="display-4 fw-bolder"> Доступные такси </h1>
            <hr>
            </center>
                <div class="form-group">
                <div class="input-group mb-3">
                    <input type="search" id="search" class="form-control" placeholder=" Поиск здесь... " aria-label="Search Here" aria-describedby="basic-addon2">
                ...
                <div id="noResult" style="display:none" class="text-center"><b> Никаких результатов!!! </b></div>
            </div>
        </div>
    </div>
</section>
<script>
    $(function(){
        ...
        $('#send_request').click(function(){
            ...
            uni_modal(" Заполните форму запроса такси ","send_request.php",'mid-large');
            else
            alert_toast(" Пожалуйста, войдите сначала .","warning");
        })
