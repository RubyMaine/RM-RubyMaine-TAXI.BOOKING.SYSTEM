    ...
    <div class="container">
        <div class="card card-outline card-purple shadow rounded-0">
            <div class="card-header">
                <h4 class="card-title"><b> Управление данными учетной записи </b></h4>
            </div>
            <div class="card-body">
                    ...
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="text" name="cab_driver" id="cab_driver" placeholder=" Введите полное имя ..." autofocus class="form-control form-control-sm form-control-border" value="<?= isset($cab_driver) ? $cab_driver : "" ?>" required>
                                <small class="ml-3"> Полное наименование: </small>
                            </div>
                        </div>
                        <div class="row">
                           
                            <div class="form-group col-md-6">
                                <input type="text" name="driver_contact" id="driver_contact" placeholder=" Введите контактный номер ..." class="form-control form-control-sm form-control-border" required value="<?= isset($driver_contact) ? $driver_contact : "" ?>">
                        ...
                        <div class="row">
                            ...
                            <textarea name="driver_address" id="driver_address" rows="3" class="form-control form-control-sm rounded-0" placeholder=" г.Ташкент, ШШайхантахурский район, ул Бунёдкор 8a (пример) "><?= isset($driver_address) ? $driver_address : "" ?></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <small class="ml-3"> Подтверждение нового пароля: </small>
                            </div>
                            <div class="col-12 mb-3"><small class="text-muted"><em> Заполните поля пароля выше, только если вы хотите обновить свой пароль. </em></small></div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                            <label for="" class="control-label"> Фотография водителей: </label>
                        ...
                        <div class="row align-items-center">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                            <button type="submit" class="btn btn-success rounded-2"><i class="fas fa-user-edit"></i> Обновить и сохранить подробности </button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
