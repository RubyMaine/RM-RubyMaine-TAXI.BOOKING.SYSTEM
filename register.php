  ...
  <div class="d-flex justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark">
    <div class="card card-outline card-purple w-75">
      <div class="card-header text-center">
        <a href="./" class="text-decoration-none text-dark"><b> Создать учетную запись - Клиент </b></a>
      </div>
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <input type="text" name="firstname" id="firstname" placeholder=" Введите имя ... " class="form-control form-control-sm form-control-border" required>
                <small class="ml-3"> Имя: </small>
            </div>
            <div class="form-group col-md-6">
                <input type="text" name="middlename" id="middlename" placeholder=" Введите фамилию ... " class="form-control form-control-sm form-control-border">
                <small class="ml-3"> Фамилия: </small>
            </div>
            <div class="form-group col-md-6">
                <input type="text" name="lastname" id="lastname" placeholder=" Введите отчество ... " class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact" placeholder=" Введите контактный номер ... " class="form-control form-control-sm form-control-border" required>
                <small class="ml-3"> Контактный номер: </small>
            </div>
          </div>
          <div class="row">
            <div class="form-group col-md-12">
              <small class="ml-3"> Адрес: </small>
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder=" Введите свой полный адрес ... "></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="simple@mail.com" class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="customFile"> Выберите фотография </label>
                    </div>
            </div>
          <div class="row">
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-8">
              <a class="btn btn-info rounded-2" href="<?php echo base_url ?>" style="text-decoration:none;"><i class="fas fa-angle-double-left"></i> Вернуться </a>
            </div>
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary rounded-2" ><i class="fas fa-check-square"></i> Зарегистрироваться </button>
            </div>
            <!-- /.col -->
          </div>
          <div class="row">
              <div class="col-12 text-center p-2">
              <a class="btn btn-success rounded-2" href="<?php echo base_url.'login.php' ?>" style="text-decoration:none;"><i class="fas fa-user-plus"></i> У вас уже есть аккаунт? </a>
              </div>
          </div>
        </form>
        <!-- /.social-auth-links -->
